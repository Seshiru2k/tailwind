...
import { contents, items } from '@heading/international_data'
            ...
            <div className="px-4 py-12 container-body">
                ...
                <div className="flex flex-col lg:flex-row">
                    <div className="overflow-x-auto lg:w-9/12">
                        <h1 className="text-lg font-bold leading-7 text-left mt-0 text-[22px] font-N text-rd">International Affairs</h1>
                        ...
                        <div className="flex flex-col">
                            <div className="flex flex-row ">
                                <h4 className="items-start justify-start w-full mt-6 mb-6 text-left border-b border-gr">
                                ...
                                <div className="flex mt-7 w-9">
                                    <button
                                        ...
                                        className="flex flex-wrap items-center justify-center w-20 h-5 text-sm border rounded text-gr hover:text-white hover:bg-maroon"
                                    >
                                        <svg
                                            ...
                                            <div className="flex flex-col lg:pt-5 hover:underline">
                                                <Link legacyBehavior href={{ pathname: `/international/${value.id}` }}>
                                                    <p
                                                        ...
                                                        className="font-bold text-rd body-font lg:text-left "
                                                    >
                                                        {value.title}
                                                    </p></Link>
                                                <p className="text-xs text-center text-gr lg:text-left">{value.created_at}</p>
                                            </div>
                                        </div>
                                    ))}
                            </div>
                    ...
                    <div className="lg:px-4 lg:w-3/12">
                        <div className="overflow-hidden mb-50">
                            <h4 className="mt-10 text-[14px] text-left lg:mt-0 font-thin text-rd">CONTENTS</h4>
